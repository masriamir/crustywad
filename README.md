...
- **Archives** — pk3 (zip) reading via the `archive` feature: members with GZDoom namespaces and short names, embedded WADs, and `maps/*.wad` maps; `cwad info`/`list`/`validate` accept a pk3.
