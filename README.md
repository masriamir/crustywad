...
Doom, **Doom II**, **Heretic**, **Hexen**, and **Doom 64** maps are all supported. Doom/Doom II/Heretic share
...
**Doom 64** maps (in nested WADs) can be read into raw typed records via `map::doom64`, with textures, flats, and colors kept as raw indices; full graph normalization is planned as a future milestone.
